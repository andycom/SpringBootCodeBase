...
public class Swagger2 {
    ...
    public Docket appApi() {
        ...
        return new Docket(DocumentationType.SWAGGER_2).groupName("demo").genericModelSubstitutes(ResponseEntity.class)
                .apiInfo(appApiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.fancv.controller"))//扫描的包
