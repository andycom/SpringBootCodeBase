...
public class ZkApi {
     ...
     * @param path 父节点path
     */
    public List<String> getChildren(String path, Boolean flag) throws KeeperException, InterruptedException {
        List<String> list = zkClient.getChildren(path, flag);
        return list;
    }
